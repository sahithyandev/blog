...
This blog was initiated with [Next.js](https://nextjs.org/), a React framework that makes it easy to do server side rendering.
Then [MDX](https://mdxjs.com/) was added. MDX is JSX and Markdown combined.
...
- [next-mdx-remote](https://www.npmjs.com/package/next-mdx-remote) - To render MDX dynamically
- [next](https://www.npmjs.com/package/next) - The next framework
- [react](https://www.npmjs.com/package/react) - Next is build on top of react
- [react-dom](https://www.npmjs.com/package/react-dom) - React needs this package