...
<Image alt="XCalc Old UI design" src={images["xcalcOldDesign"]} width={375} height={667} placeholder="blur" />
...
<Image alt="XCalc New UI design" src={images["xcalcNewDesign"]} width={1366} height={768} placeholder="blur" />
