...
```
let strValue = "true"
let boolValue = strValue == "true" ? true : false // returns true
```
...
```
age > 13 ? (
// do something when age is higher than 13
) : (
// do something when age is not higher than 13
)
```
...
console.log(name.split('')) // [S, a, h, i, t, h, y, a, n]
```
...
console.log([...name]) // [S, a, h, i, t, h, y, a, n]
```
