...
So, what functions did I add? Here is a list. 
...
### Off-thread evaluations (Web Workers)
...
With the use of service workers, web apps can now deliver a custom offline experience. For example, YouTube and Spotify have a custom offline page. While searching for more examples, I found this awesome sudoku game, which provides the same experience when online and offline.
...
If you have read this much, Thank you. If you have any questions? Feel free to reach me out on twitter, or any other platforms.
